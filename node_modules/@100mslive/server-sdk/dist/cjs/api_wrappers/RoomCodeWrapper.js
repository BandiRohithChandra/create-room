...
class RoomCodeWrapper {
     ...
     */
    list(roomId, filters) {
        const queryObjectIterable = new QueryObjectIterator_1.QueryObjectIterator((queryParams) => this.apiService.get(`${this.basePath}/room/${roomId}`, queryParams), filters !== null && filters !== void 0 ? filters : {});
...
exports.default = RoomCodeWrapper;
