...
class LiveStreamWrapper {
     ...
     */
    list(filters) {
        const queryObjectIterable = new QueryObjectIterator_1.QueryObjectIterator((queryParams) => this.apiService.get(this.basePath, queryParams), filters !== null && filters !== void 0 ? filters : {});
     ...
     * @returns a `HMS.LiveStream.Object` object
     */
    sendTimedMetadata(streamId, params) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = LiveStreamWrapper;
//# sourceMappingURL=LiveStreamWrapper.js.map