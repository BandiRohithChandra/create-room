...
class AuthService {
    ...
    getManagementToken(tokenConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            if ((tokenConfig === null || tokenConfig === void 0 ? void 0 : tokenConfig.forceNew) ||
                ...
                LoggerService_1.logger.debug("generating management token", tokenConfig);
                this.managementToken = yield this.generateToken(types_1.TokenType.Management, tokenConfig);
            }
    ...
    getAuthToken(tokenConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.generateToken(types_1.TokenType.Auth, tokenConfig, details);
        });
    }
    ...
    isTokenExpired(token) {
        try {
            ...
            LoggerService_1.logger.error("error in decoding token", err);
        }
    }
    signAndGetJwt(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                (0, jsonwebtoken_1.sign)(payload, this.secret, options, (err, token) => {
                    if (err || !token) {
                        reject(err);
                    }
                    else {
