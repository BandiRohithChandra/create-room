...
export default class RoomCodeWrapper {
     ...
     */
    list(roomId, filters) {
        const queryObjectIterable = new QueryObjectIterator((queryParams) => this.apiService.get(`${this.basePath}/room/${roomId}`, queryParams), filters !== null && filters !== void 0 ? filters : {});
