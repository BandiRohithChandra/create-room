 ...
 * ```
 */
export class QueryObjectIterator {
    ...
    [Symbol.asyncIterator]() {
        ...
        return __asyncGenerator(this, arguments, function* _m() {
            ...
            while (!this.results ||
                ...
                let data = (_d = (_c = this.results) === null || _c === void 0 ? void 0 : _c.data) !== null && _d !== void 0 ? _d : (_e = this.results) === null || _e === void 0 ? void 0 : _e.events;
                // set "last" of latest query as "start" for current query
                if (((_f = this.results) === null || _f === void 0 ? void 0 : _f.last) || ((_g = this.results) === null || _g === void 0 ? void 0 : _g.next)) {
                    this.queryParams["start"] =
                        (_j = (_h = this.results) === null || _h === void 0 ? void 0 : _h.last) !== null && _j !== void 0 ? _j : (_k = this.results) === null || _k === void 0 ? void 0 : _k.next;
                }
                ...
                if (data) {
                    ...
                    if ((_l = data.length < this.queryParams["limit"]) !== null && _l !== void 0 ? _l : 10)
                        break;
                }
            }
        });
